...
let bioPerfil = document.querySelector('.bio span');
let localizacaoPerfil = document.querySelector('.localizacao span');
...
const fillUser = (data)=>{
    ...
    infoMain.bio === null ? bioPerfil.innerHTML = "Sem Biografia" : bioPerfil.innerHTML = infoMain.bio ;
    infoMain.bio === undefined ? bioPerfil.innerHTML = "Bio" : bioPerfil.innerHTML = infoMain.bio ;
    infoMain.location === null ? localizacaoPerfil.innerHTML = "Sem localização" : localizacaoPerfil.innerHTML = infoMain.location;
    infoMain.location === undefined ? localizacaoPerfil.innerHTML = "Localização" : localizacaoPerfil.innerHTML = infoMain.location;
