...
const fillUser = (data)=>{
    ...
    if(infoMain.bio === null){
        document.querySelector('.bio > span').innerText = "Sem bio";
    }else if(infoMain.bio === undefined){
        document.querySelector('.bio > span').innerText = "Usuário inválido";
    }else{
        document.querySelector('.bio > span').innerText = infoMain.bio;
    }

    if(infoMain.location === null){
        document.querySelector('.localizacao > span').innerText = "Sem localização";
    }else if(infoMain.location === undefined){
        document.querySelector('.localizacao > span').innerText = "Usuário inválido";
    }else{
        document.querySelector('.localizacao > span').innerText = infoMain.location;
    }
